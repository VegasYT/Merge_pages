...
export default function AddBlockModal({ categories, blockTemplates, onClose, onAddBlock }: AddBlockModalProps) {
	...
	const filteredTemplates = selectedCategory ? blockTemplates.filter((t) => t.category_id === selectedCategory) : blockTemplates;
		...
		>
			...
			>
				<div className="flex items-center justify-between p-6 border-b bg-gradient-to-r from-blue-50 to-purple-50">
					<h2 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Добавить блок</h2>
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
							{filteredTemplates.map((template) => (
								...
								>
									...
									<div className="p-4">
										<h4 className="font-semibold text-gray-800 group-hover:text-blue-600 transition-colors">{template.name}</h4>
